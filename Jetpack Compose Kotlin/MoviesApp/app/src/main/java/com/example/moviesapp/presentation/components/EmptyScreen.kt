...
fun EmptyScreen(
    ...
    val message: String = error?.message ?: stringResource(id = R.string.empty_data)
...
@Composable
fun EmptyContent(alphaAnim: Float, message: String, iconId: Int, modifier: Modifier = Modifier) {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .testTag("emptyList"),
...
fun EmptyScreenPreview() {
    EmptyContent(
        alphaAnim = 0.3f,
        message = "You have not saved movie so far !",
