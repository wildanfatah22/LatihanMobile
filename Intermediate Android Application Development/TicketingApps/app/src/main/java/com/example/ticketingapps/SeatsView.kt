...
class SeatsView: View {
    ...
    constructor(context: Context1): super(context)

    constructor(context: Context1, attrs: AttributeSet) : super(context, attrs)

    constructor(context: Context1, attrs: AttributeSet, defStyleAttr: Int) : super(
        context,
        attrs,
        defStyleAttr
    )
